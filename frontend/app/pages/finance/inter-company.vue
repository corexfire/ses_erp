    ...
    <div v-if="dialogOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md transition-all">
      <div class="relative w-full max-w-2xl max-h-[92vh] bg-white shadow-2xl flex flex-col overflow-hidden animate-scale-in rounded-[2.5rem] border-4 border-white text-slate-900 border-b-[12px] border-b-orange-900">
        ...
        <div class="flex-1 overflow-y-auto p-10 space-y-10 custom-scrollbar bg-slate-50/30 pb-32">
           <!-- Alert Logic -->
           <div v-if="form.amount > 1000000000" class="p-4 bg-amber-50 border border-amber-200 rounded-2xl flex gap-4 animate-fade-in-up">
           ...
           <div v-if="form.fromCompanyId && form.fromCompanyId === form.toCompanyId" class="p-4 bg-rose-50 border border-rose-200 rounded-2xl flex gap-4 animate-fade-in-up">
