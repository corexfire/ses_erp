<template>
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in-up mt-4">
      <div class="p-4 rounded-2xl bg-amber-600 text-white shadow-xl flex flex-col justify-between border border-amber-500 transition-all hover:bg-amber-700 group">
