  ...
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in-up mt-4">
      ...
      <div class="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between transition-all hover:shadow-xl hover:-translate-y-1">
       ...
       <div class="p-4 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-700 text-white shadow-xl flex flex-col justify-between relative overflow-hidden group">
           ...
           <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div class="lg:col-span-4 animate-fade-in-up">
                 ...
                 <div class="bg-white p-8 rounded-[2rem] border-2 border-slate-100 shadow-sm space-y-6 transition-all hover:border-blue-100">
                    ...
                    <div class="bg-blue-50 p-4 rounded-[1.5rem] border border-blue-100 shadow-inner">
