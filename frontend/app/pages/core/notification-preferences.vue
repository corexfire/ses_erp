  ...
  <div class="p-6 space-y-8 bg-slate-50/50 min-h-screen">
    ...
    <div v-for="cat in categories" :key="cat.name" class="space-y-4">
       ...
       <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div v-for="pref in cat.prefs" :key="pref.eventKey" class="group relative p-6 rounded-xl bg-white border border-slate-200 shadow-sm transition-all duration-300 hover:border-indigo-300 hover:shadow-lg flex items-center justify-between">
