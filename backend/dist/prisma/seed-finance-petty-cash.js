...
exports.seedPettyCash = seedPettyCash;
async function seedPettyCash(prisma, tenantId) {
    ...
    const opexCoa = await prisma.coaAccount.findFirst({ where: { tenantId, code: '6-2400-00' } });
    if (!pettyCoa) {
    ...
    const pettyAccount = await prisma.cashAccount.upsert({
        ...
        update: { coaAccountId: pettyCoa.id, balance: 1500000 },
        create: {
            id: 'petty-cash-ops',
            tenantId,
...
//# sourceMappingURL=seed-finance-petty-cash.js.map