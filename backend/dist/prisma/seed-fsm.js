...
exports.seedFsm = seedFsm;
const client_1 = require("./generated/client");
async function seedFsm(prisma, tenantId) {
    ...
    const getCustomer = (idx) => customers[idx] || customers[0];
    const serviceOrderData = [
        {
            code: 'SO-FSM-2024-001',
            customerId: customer1.id,
            subject: 'Pemasangan Unit AC VRV - Lantai 8 & 9',
            serviceType: client_1.FsmServiceType.INSTALLATION,
            priority: client_1.TicketPriority.HIGH,
            status: client_1.FsmServiceOrderStatus.COMPLETED,
        ...
        },
        {
            ...
            serviceType: client_1.FsmServiceType.REPAIR,
            priority: client_1.TicketPriority.URGENT,
            status: client_1.FsmServiceOrderStatus.IN_PROGRESS,
        ...
        },
        {
            ...
            serviceType: client_1.FsmServiceType.MAINTENANCE,
            priority: client_1.TicketPriority.MEDIUM,
            status: client_1.FsmServiceOrderStatus.SCHEDULED,
        ...
        },
        {
            ...
            serviceType: client_1.FsmServiceType.INSPECTION,
            priority: client_1.TicketPriority.LOW,
            status: client_1.FsmServiceOrderStatus.DRAFT,
        ...
        },
        {
            ...
            serviceType: client_1.FsmServiceType.INSTALLATION,
            priority: client_1.TicketPriority.HIGH,
            status: client_1.FsmServiceOrderStatus.SUBMITTED,
        ...
        },
        {
            ...
            serviceType: client_1.FsmServiceType.REPAIR,
            priority: client_1.TicketPriority.HIGH,
            status: client_1.FsmServiceOrderStatus.PENDING_SCHEDULE,
    ...
    for (const so of createdOrders) {
        ...
        if (existingAppts > 0)
            continue;
        const now = new Date();
        if (so.status === client_1.FsmServiceOrderStatus.COMPLETED) {
            ...
            const appt = await prisma.fsmServiceAppointment.create({
                data: {
                    ...
                    status: client_1.FsmAppointmentStatus.COMPLETED,
        ...
        else if (so.status === client_1.FsmServiceOrderStatus.IN_PROGRESS) {
            await prisma.fsmServiceAppointment.create({
                data: {
                    tenantId,
                    serviceOrderId: so.id,
                    technicianId: tech2.id,
                    status: client_1.FsmAppointmentStatus.IN_PROGRESS,
                    scheduledStart: now,
        ...
        else if (so.status === client_1.FsmServiceOrderStatus.SCHEDULED) {
            ...
            await prisma.fsmServiceAppointment.create({
                data: {
                    ...
                    status: client_1.FsmAppointmentStatus.ASSIGNED,
...
//# sourceMappingURL=seed-fsm.js.map