...
async function main() {
    ...
    for (let i = 0; i < 35; i++) {
        ...
        submissionDeadline.setDate(submissionDeadline.getDate() + (Math.floor(Math.random() * 30) - 10));
        let awardDate = new Date(submissionDeadline);
...
//# sourceMappingURL=seed-tender.js.map