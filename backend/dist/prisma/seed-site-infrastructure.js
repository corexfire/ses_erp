...
exports.seedSiteInfrastructure = seedSiteInfrastructure;
async function seedSiteInfrastructure(prisma, tenantId) {
        ...
        for (const [i, zone] of zones.entries()) {
            ...
            const site = await prisma.projectSite.upsert({
                ...
                create: {
                    ...
                    province: 'Jawa Barat',
                    gpsCoords: isConstruction ? `-6.234${i}, 106.98${i + 2}` : `-6.589${i}, 106.84${i + 5}`,
...
//# sourceMappingURL=seed-site-infrastructure.js.map