    ...
    for (const project of projects) {
        ...
        const budget = await prisma.projectBudget.upsert({
            ...
            create: {
                ...
                totalAmount: isConstruction ? 2500000000 : 850000000,
        ...
        const linesData = [];
        if (isConstruction) {
            linesData.push({ category: 'MATERIAL', desc: 'Beton Ready Mix K-350', price: 1200000, qty: 500, uom: 'M3' }, { category: 'MATERIAL', desc: 'Baja Tulangan U-40', price: 15000, qty: 25000, uom: 'KG' }, { category: 'LABOR', desc: 'Mandor Lapangan Professional', price: 250000, qty: 180, uom: 'MD' }, { category: 'EQUIP', desc: 'Sewa Excavator PC200', price: 350000, qty: 120, uom: 'JAM' }, { category: 'SUBCO', desc: 'Pekerjaan Bored Pile (Vendor)', price: 850000000, qty: 1, uom: 'LS' }, { category: 'OTHER', desc: 'K3 & Safety Mobilization', price: 50000000, qty: 1, uom: 'LS' });
        }
        else {
            linesData.push({ category: 'LABOR', desc: 'Senior Software Architect', price: 45000000, qty: 6, uom: 'MONTH' }, { category: 'LABOR', desc: 'Fullstack Developers (3 Pax)', price: 75000000, qty: 6, uom: 'MONTH' }, { category: 'EQUIP', desc: 'Cloud Infrastructure (AWS/Azure)', price: 12000000, qty: 12, uom: 'MONTH' }, { category: 'EQUIP', desc: 'Dev Container Licenses', price: 500000, qty: 10, uom: 'PCS' }, { category: 'OTHER', desc: 'Quality Assurance & Testing Tools', price: 25000000, qty: 1, uom: 'LS' });
        }
