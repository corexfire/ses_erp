...
async function main() {
    ...
    for (let i = 0; i < 45; i++) {
        ...
        if (billingCycle === 'DAILY')
            baseRate = 2000000 + Math.random() * 3000000;
        if (billingCycle === 'WEEKLY')
            baseRate = 12000000 + Math.random() * 8000000;
        if (billingCycle === 'MONTHLY')
            baseRate = 45000000 + Math.random() * 50000000;
        if (billingCycle === 'YEARLY')
            baseRate = 500000000 + Math.random() * 200000000;
