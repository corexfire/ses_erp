...
exports.seedProjectTenderIntegrated = seedProjectTenderIntegrated;
async function seedProjectTenderIntegrated(prisma, tenantId) {
    ...
    for (let i = 0; i < dbSuppliers.length; i++) {
        const isWinner = bidPrices[i] === 42500000000;
...
//# sourceMappingURL=seed-project-tender-integrated.js.map