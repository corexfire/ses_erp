...
async function seedTasks(prisma, tenantId) {
    ...
    if (firstProject) {
        ...
        const deadlineScenarios = [
            { code: 'DL-01', name: 'Submit Final Report', offset: -5, status: 'IN_PROGRESS' },
            { code: 'DL-02', name: 'Client Presentation', offset: 0, status: 'PENDING' },
            { code: 'DL-03', name: 'Internal Audit Review', offset: 3, status: 'PENDING' },
            { code: 'DL-04', name: 'Resource Allocation Planning', offset: 15, status: 'PENDING' },
        ];
