...
exports.seedTaxIdBillingIntegrated = seedTaxIdBillingIntegrated;
async function seedTaxIdBillingIntegrated(prisma, tenantId) {
    console.log('🌱 Seeding Integrated ID Billing (Tax Payments) for FY 2026...');
    const bankAccount = await prisma.coaAccount.findUnique({ where: { tenantId_code: { tenantId, code: '1-1110-00' } } });
...
//# sourceMappingURL=seed-tax-id-billing-integrated.js.map