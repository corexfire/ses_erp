...
exports.seedHrisRecruitmentIntegrated = seedHrisRecruitmentIntegrated;
async function seedHrisRecruitmentIntegrated(prisma, tenantId) {
    ...
    const getDept = (code) => departments.find(d => d.code === code)?.name || 'General';
    const candidates = [
...
//# sourceMappingURL=seed-hris-recruitment-integrated.js.map