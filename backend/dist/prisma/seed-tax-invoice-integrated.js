...
exports.seedTaxInvoiceIntegrated = seedTaxInvoiceIntegrated;
async function seedTaxInvoiceIntegrated(prisma, tenantId) {
    ...
    for (const c of customers) {
        const cust = await prisma.customer.upsert({
            ...
            update: { npwp: c.npwp, nik: c.nik, taxAddress: c.address },
            create: {
                tenantId,
                code: c.code,
                name: c.name,
...
//# sourceMappingURL=seed-tax-invoice-integrated.js.map