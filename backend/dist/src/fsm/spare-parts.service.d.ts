...
export declare class SparePartsService {
    ...
    findAll(tenantId: string | null, query?: string, isSuperAdmin?: boolean): Promise<({
        itemGroup: {
            id: string;
            tenantId: string;
            name: string;
    ...
    findOne(tenantId: string | null, id: string, isSuperAdmin?: boolean): Promise<{
        itemGroup: {
            id: string;
            tenantId: string;
            name: string;
    ...
    getStats(tenantId: string | null, isSuperAdmin?: boolean): Promise<{
        total: number;
        lowStock: number;
        totalValue: number;
    }>;
