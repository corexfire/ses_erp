...
exports.DailyProgressController = exports.CreateDailyProgressDto = void 0;
const common_1 = require("@nestjs/common");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
const permissions_decorator_1 = require("../auth/permissions.decorator");
const permissions_guard_1 = require("../auth/permissions.guard");
const prisma_service_1 = require("../prisma/prisma.service");
class CreateDailyProgressDto {
    projectId;
    reportDate;
    morningWeather;
    afternoonWeather;
...
exports.CreateDailyProgressDto = CreateDailyProgressDto;
let DailyProgressController = class DailyProgressController {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
...
], DailyProgressController.prototype, "list", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DailyProgressController.prototype, "getStats", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, CreateDailyProgressDto]),
    __metadata("design:returntype", Promise)
], DailyProgressController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('project.site.execute'),
    ...
    __metadata("design:returntype", Promise)
], DailyProgressController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DailyProgressController.prototype, "remove", null);
exports.DailyProgressController = DailyProgressController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard),
    (0, common_1.Controller)('construction/daily-progress'),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], DailyProgressController);
//# sourceMappingURL=daily-progress.controller.js.map