...
let SubscriptionsController = class SubscriptionsController {
    ...
    async create(req, body) {
        ...
        await this.audit.log(user.tenantId, user.id, 'CREATE', 'SalesSubscription', sub.id, null, sub);
    ...
    async update(req, id, body) {
        ...
        await this.audit.log(user.tenantId, user.id, 'UPDATE', 'SalesSubscription', id, existing, updated);
