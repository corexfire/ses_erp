...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)('finance.bank.read'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BankController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('finance.bank.read'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", Promise)
], BankController.prototype, "get", null);
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('finance.bank.create'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('finance.bank.transaction'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
...
exports.BankController = BankController = __decorate([
    ...
    (0, common_1.Controller)('finance/bank'),
