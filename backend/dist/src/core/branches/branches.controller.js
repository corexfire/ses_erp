...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)('core.branch.read'),
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('core.branch.create'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.RequirePermissions)('core.branch.update'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('core.branch.deactivate'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
...
exports.BranchesController = BranchesController = __decorate([
    ...
    (0, common_1.Controller)('core/branches'),
