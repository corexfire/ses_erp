...
async function main() {
  ...
  // 5. Seed PPh 21 Employee Records
  const pph21Data = [
    ...
    { transNo: 'PAY/2026/04/04', transDate: new Date('2026-04-25'), taxpayerName: 'Lina Marlina', npwp: null, grossAmount: 6000000, rate: 6, taxAmount: 360000 }, // Non-NPWP penalty
